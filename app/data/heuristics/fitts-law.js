export default {
  ...
  en: {
    title: 'Fitts\'s Law',
    subtitle: 'Time to click depends on target size and distance',
    shortDescription: 'The time to acquire a target is a function of the distance to and size of the target.',
    history: 'Paul Fitts, a psychologist, studied the human motor system and created a mathematical model that predicts the time needed to rapidly move to a target area. It was initially used in ergonomics and later became fundamental to interface design.',
    purpose: 'Guide the positioning and sizing of interactive elements in interfaces.',
    whyRedFlag: 'When important buttons are too small or too far from the user\'s cursor/finger, interaction becomes slow and frustrating. This indicates a lack of consideration for basic ergonomics principles. The opportunity lies in enlarging important targets, placing related elements close together, and putting frequent actions in easy-to-reach areas.',
    eli5: 'It\'s easier to hit a big, close target than a small, faraway one!',
    detailed: 'Fitts\'s Law establishes that the time T to move the cursor to a target is: T = a + b × log₂(1 + D/W), where D is the distance to the target and W is the width of the target. Practical implications: important buttons should be large; related elements should be close together; screen edges and corners are infinitely "large" (the cursor stops at them); action buttons should be near where the user is looking/interacting.',
  },
  pt: {
    title: 'Fitts\'s Law',
