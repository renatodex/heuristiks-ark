export const ui = {
  en: {
    ...
    storySub: 'How it actually happened 📜',
    lessonTitle: 'The Lesson',
    lessonSub: 'What this story teaches',
    protagonistTitle: 'Key Figures',
  ...
  pt: {
    ...
    storySub: 'Como realmente aconteceu 📜',
    lessonTitle: 'A Lição',
    lessonSub: 'O que essa história ensina',
    protagonistTitle: 'Personagens Centrais',
